...
class TicketSummarizer:
    ...
    def __init__(self, location_corrector: LocationCorrector):
        ...
        self.system_prompt = (
            ...
            '     * 使用"来电人"、"市民"、"当事人"等第三人称\n'
            "   - 话务员解答内容：以话务员最新、最完整的总结为准，包含具体解决方案或办理流程\n"
            '     * 使用"话务员"、"工作人员"等第三人称\n'
            '   示例："来电人咨询：市民询问居民医保如何暂停参保。话务员解答内容：话务员已告知市民有3种办理方式：1. 携带相关证件前往政务中心办理停保；2. 线上添加办公QQ好友，上传相关证件办理；3. 本人通过手机微信小程序\'安徽医保公共服务\'线上办理"\n\n'
            "【输出规则】\n"
            "- 只输出JSON，不要任何额外解释\n"
            "- 字段名称必须完全一致，不能使用其他名称\n"
            "- 所有字段都是必填项"
...
{{
  ...
  "ticket_title": "一句话概括",
  "ticket_content": "来电人咨询：[使用第三人称客观描述市民反映的内容，不要用"我"、"您"，要用"市民"、"来电人"等称呼，包括门牌号、手机号、金额、时间等具体信息，数字使用阿拉伯数字] 话务员解答内容：[使用第三人称描述话务员的解答，不要用"我"、"您"，要用"话务员"、"工作人员"等称呼]"
}}

重要提示：ticket_content必须使用第三人称客观叙述，避免第一、第二人称。"""
